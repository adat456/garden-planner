...
const BedResultPreview: React.FC<bedResultPreviewInterface> = function({ bed }) {
    ...
    const userObj = useGetUserQuery(undefined, {
        selectFromResult: ({ data }) => ({
            favoritedBeds: data?.favorited_beds
        }),
    });
    const favoritedBeds = userObj?.favoritedBeds;
        ...
        <div className="bed-result-preview">
            ...
            <div className="info">
                ...
                <div className="favorite">
                    <button type="button" ref={heartButtonRef} className={favoritedBeds?.includes(bed.id) ? "favorite" : undefined} onClick={handleToggleFavorite} title="Add bed to favorites">
